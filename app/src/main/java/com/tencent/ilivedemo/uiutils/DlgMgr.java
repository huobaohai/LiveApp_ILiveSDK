...
public class DlgMgr {
    ...
    private static void customDemoDialog(Context context, AlertDialog dialog){
        try {
            // 修改样式
    ...
    public static AlertDialog showAlertDlg(Context context, AlertDialog.Builder builder) {
        ...
        alertDialog.show();
        customDemoDialog(context, alertDialog);
        return alertDialog;
    }

    public static void dismissDlg(AlertDialog dialog) {
